...
export default function AccountNav() {
  ...
  return (
    <>
      ...
      {
        cookieValue?.user ? <div className="flex items-center gap-1 text-base capitalize">
          <Link className="flex items-center gap-1 text-base capitalize" href={routes.user_dashboard}>
            <ProfileIcon /> <span>{my_account}</span>
          </Link>
        </div> : <div className="flex items-center gap-1 text-base capitalize">
          <Link className="flex items-center gap-1 text-base capitalize" href='/login'>
      ...
      <div className="flex items-center gap-1 text-base capitalize shoppingCart relative">
        ...
        <Dialog open={openCart} onOpenChange={setOpenCart} >
          ...
          <div className="flex items-center gap-1 text-base capitalize cursor-pointer " onClick={() => setOpenCart(!openCart)} >
